  ...
  return (
    <div className="sort-wrapper">
      ...
      <select className="my-select">
        <option onClick={(e) => props.handleSort(e)}>Original &#8886;</option>
        <option onClick={(e) => props.handleSort(e)}>Ascending &#9650;</option>
        <option onClick={(e) => props.handleSort(e)}>Descending &#9660;</option>
      </select>
    </div>
  );
};
...
class App extends React.Component {
  ...
  render() {
    const searchedItems = this.state.list.filter((item) =>
      item.value.toLocaleLowerCase().includes(this.state.searchInput)
    );
    ...
    return (
      <div className="App">
        ...
        {this.state.sort === true && (
          <List
            list={
              this.state.searchInput !== "" ? searchedItems : ascendingPriority
            }
            handleToggle={this.handleToggle}
            handleRemove={this.handleRemove}
            hendleDecrementPriority={this.handleDecrementPriority}
        ...
        {this.state.sort === false && (
          <List
            list={
              this.state.searchInput !== "" ? searchedItems : descendingPriority
            }
            handleToggle={this.handleToggle}
            handleRemove={this.handleRemove}
            hendleDecrementPriority={this.handleDecrementPriority}
